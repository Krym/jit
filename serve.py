...
urls = (
    '/testcase/(RGraph|Treemap|Icicle|InfoHypertree|Hypertree|Spacetree|ForceDirected|ForceDirected3D|Sunburst|AreaChart|BarChart|PieChart|TimeGraph|HeatMap|Voronoi|Other)/([0-9]+)/?', 'testcase',
)
